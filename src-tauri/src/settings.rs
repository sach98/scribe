...
impl Default for KeyboardImplementation {
    fn default() -> Self {
        ...
        return KeyboardImplementation::ScribeKeys;
    }
}
...
/// and `Dark` force one of the two palettes Scribe already ships.
#[derive(Serialize, Deserialize, Debug, Clone, Copy, PartialEq, Eq, Type)]
#[serde(rename_all = "snake_case")]
pub enum Theme {
    System,
...
mod tests {
    ...
    fn frozen_v0_9_store_parses_strictly_without_migration() {
        ...
        let stored: serde_json::Value = serde_json::from_str(
            ...
            "experimental_enabled": false,
            "lazy_stream_close": false,
            "keyboard_implementation": "scribe_keys",
            "show_tray_icon": true,
            "paste_delay_ms": 60,
            "typing_tool": "auto",
    ...
    fn salvage_drops_only_wrong_typed_fields() {
        ...
        map.insert("custom_words".into(), serde_json::json!(["scribe"]));
        ...
        assert_eq!(salvaged.sound_theme, default_sound_theme());
        assert_eq!(salvaged.custom_words, vec!["scribe".to_string()]);
    }
