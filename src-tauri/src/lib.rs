...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            shortcut::scribe_keys::start_scribe_keys_recording,
            shortcut::scribe_keys::stop_scribe_keys_recording,
    ...
    // Single-instance forwards CLI args to an already-running Scribe and exits.
